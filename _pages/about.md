...
## About Me 🏄‍♂️ 
Xi Ding is a researcher in **machine learning** with a focus on making artificial intelligence (AI) more **trustworthy, interpretable, and robust**. He completed his Master of Computing degree at the Australian National University (ANU) in 2025, where he specialized in machine learning. He is currently a research intern at Carnegie Mellon University (CMU) advised by Prof. [Min Xu](https://xulabs.github.io/min-xu/) and a visiting scholar at the [Australian Research Council (ARC) Research Hub](https://www.griffith.edu.au/griffith-sciences/farming-productivity) advised by [Prof. Yongsheng Gao](https://experts.griffith.edu.au/19112-yongsheng-gao). Previously, he worked at the [TIME Lab](https://time.griffith.edu.au/) as a research assistant advised by [Dr. Lei Wang](https://leiwangr.github.io/), where he conducted research on video understanding tasks, particularly leveraging vision-language models to improve action recognition and anomaly detection.

Xi’s research centers on building reliable, interpretable, and generalizable machine learning frameworks. He works on trust-aware domain adaptation, temporal reasoning, uncertainty-guided kernel methods, and graph-based learning for structured data to better understand how models perceive, represent, and reason about information across modalities such as text, vision, and temporal signals. Broadly, he aims to make modern AI not only accurate but also transparent and robust in real-world environments.
...
- 2025-03-17 — Appointed as an ARC Research Hub Scholar.
