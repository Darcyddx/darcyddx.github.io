...
At the [TIME Lab](https://time.griffith.edu.au/) ⏳, Xi worked as a Research Assistant supervised by [Dr. Wang](https://leiwangr.github.io/), where he applied vision-language models to advance video understanding tasks such as action recognition and anomaly detection. His research focused on helping AI capture long-term patterns, improve interpretability, and provide clearer explanations for its decisions.   
