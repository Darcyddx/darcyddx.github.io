...
My research centers on building **reliable, interpretable, and generalizable machine learning frameworks**. My work spans multimodal learning, graph-based learning, trust-aware domain adaptation, temporal reasoning, and uncertainty-guided kernel methods. <span style="color:#FF4500;">Research Passion</span>: I am deeply motivated by the question of how we can design AI systems that not only perform well, but also align with human understanding, operate transparently, and remain robust in high-stakes settings.
